...
namespace SpotiWiFi.Test.Domain
{
    public class CartaoTests
    {
        ...
        public void DeveCriarTransacaoComSucesso()
        {
            ...
            var merchant = new SpotiWiFi.Domain.Transacao.ValueObject.Merchant()
            {
                Nome = "Dummy"
            };
        ...
        public void NaoDeveCriarTransacaoComCartaoValorDuplicado()
        {
            ...
            cartao.Transacoes.Add(new SpotiWiFi.Domain.Transacao.Aggregates.Transacao()
            {
                DtTransacao = DateTime.Now,
                Id = Guid.NewGuid(),
                Merchant = new SpotiWiFi.Domain.Transacao.ValueObject.Merchant()
                {
                    Nome = "Dummy"
                },
                Valor = 19M,
