    ...
    public partial class InitialDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Endereco = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CPF_Numero = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    EnderecoCobrancaId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Usuario", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Usuario_EnderecoCobranca_EnderecoCobrancaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Usuario_EnderecoCobrancaId",
                table: "Usuario",
